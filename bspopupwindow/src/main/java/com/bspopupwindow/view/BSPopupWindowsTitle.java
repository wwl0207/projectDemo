...
package com.bspopupwindow.view;
...
import com.bspopupwindow.R;
import com.bspopupwindow.adapter.PopupListAdapter;
import com.bspopupwindow.model.TreeVO;
import com.bspopupwindow.utils.BaseCommonUtils;
import com.bspopupwindow.utils.DateUtils;
import com.bspopupwindow.view.pickdate.PickTimeView;
...
//            this.update();
    ...
    public BSPopupWindowsTitle(final Activity context, final List<TreeVO> array, TreeCallBack callback, int height) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(context, list, R.layout.dropdown_one_leve_item,
                new String[]{"option"}, new int[]{R.id.textview
        });
        ...
        LayoutParams params = new LayoutParams(
                LayoutParams.MATCH_PARENT, height);// 定义文本显示组件
    ...
    public void CreateListView(final ArrayList<TreeVO> list) {
        ...
        LayoutParams params = new LayoutParams(
                ...
                BaseCommonUtils.getScreenHigh(mContext) / 2);// 定义文本显示组件
...
//        view.setVisibility(View.VISIBLE);
        ...
        startLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startLayout.setBackgroundColor(mContext.getResources().getColor(R.color.primary));
                endNameTv.setTextColor(mContext.getResources().getColor(R.color.primary));
                endTimeTv.setTextColor(mContext.getResources().getColor(R.color.primary));
        ...
        endLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startNameTv.setTextColor(mContext.getResources().getColor(R.color.primary));
                startTimeTv.setTextColor(mContext.getResources().getColor(R.color.primary));
                ...
                endLayout.setBackgroundColor(mContext.getResources().getColor(R.color.primary));
