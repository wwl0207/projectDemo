package com.bs.android.customview;

/**
 * created by WWL on 2019/4/23 0023:11
 */
...
public class SpikeDownTimerView extends LinearLayout {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (tv_day_decade.getText().toString().equals("0") && tv_day_unit.getText().toString().equals("0")){
    ...
    public SpikeDownTimerView(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.spike_countdowntimer, this);
