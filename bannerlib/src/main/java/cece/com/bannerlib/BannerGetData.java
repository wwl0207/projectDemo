...
public class BannerGetData {
     ...
     */
    public static void getBannerData(Context context, OnItemViewClickListener listener, RelativeLayout rl_banner, List<PicBean> list, boolean cardMode, int NormalColor, int SelectorColor, int dotWidth, int dotHeight, int shape) {
